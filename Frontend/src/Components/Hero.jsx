...
export default function Hero() {
  const [mobileMenuOpen, setMobileMenuOpen] = useState(false)
    ...
    return (
      <>
    <div  id='hero' className="bg-[#161B22]">
      <header className="absolute inset-x-0 top-0 z-50">
        <nav aria-label="Global" className="flex items-center justify-between p-6 lg:px-8">
          <div className="flex lg:flex-1">
            <a href="/" className="-m-1.5 p-1.5">
                  <span className="sr-only">ServiceEase</span>
                  <div className="logo">
  <a 
    href="/" 
  ...
  >ServiceEase
        ...
        <Dialog open={mobileMenuOpen} onClose={setMobileMenuOpen} className="lg:hidden">
          ...
          <DialogPanel className="fixed inset-y-0 right-0 z-50 w-2/3 overflow-y-auto bg-purple-200 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-14 lg:py-20">
          ...
          <div className="text-center">
            ...
            Trusted Services. Book with Ease.
            </h1>
            <p className="mt-8 text-lg font-medium text-pretty text-white sm:text-xl/8">
             Need Help? We've Got You Covered.
                </p>
                <p className="mt-8 text-lg font-medium text-pretty text-white sm:text-xl/8">
            From plugs to paint — find trusted professionals right at your fingertips.
          <br className="hidden md:block" />
          Explore Best Home Services & Repair Near You — all in one place.
            </p>
